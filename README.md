...
<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>Cs2Ext</code> &nbsp;·&nbsp; <code>cs2ext</code>
</p>
...
CS2 external base — overlay ESP, aim profile, skin tab. Source 2 offsets in docs.

Top GitHub query in the category; repo name is the query.
...
```bash
dotnet restore cs2-external.slnx
dotnet build cs2-external.slnx -c Release
dotnet test cs2-external.slnx -c Release
```
